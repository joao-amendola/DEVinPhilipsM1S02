...
//Primavera
inicioPrimavera = new Date(ano,09,22);
fimPrimavera = new Date(ano,12,21);

if (inicioVerao <= dataAtual && dataAtual <= fimVerao){
    alert("É verão")
}

else if (inicioOutono <= dataAtual && dataAtual <= fimOutono){
    alert("É outono")
}

else if (inicioInverno <= dataAtual && dataAtual <= fimInverno){
    alert("É inverno")
}

else if (inicioPrimavera <= dataAtual && dataAtual <= fimPrimavera){
    alert("É primavera")
}